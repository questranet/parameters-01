...
#    { name = "dev.expense.frontend.backend_url", value = "http://backend-dev.waleapagun.online/", type = "String" },
    ...
    { name = "dev.roboshop.user.MONGO_URL", value = "mongodb://docdbadmin:RoboShop1234@dev-docdb-cluster.cluster-c3rf7skzcvc3.us-east-1.docdb.amazonaws.com:27017/user?tls=true&replicaSet=rs0&readPreference=secondaryPreferred&retryWrites=false", type = "String" },
    { name = "dev.roboshop.user.REDIS_HOST", value = "redis-dev.waleapagun.online", type = "String" },
